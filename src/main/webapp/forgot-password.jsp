						...
						<form method="post" action="ForgotPassword">
							<div class="kqsx-first">
								<div class="box-kqxs" id="box-ckqxs">
												...
												<div class="col-md-7">
													<table class="table">
														<tbody>
															<tr>
																<td>Tên đăng nhập</td>
																<td><input type="text" class="form-control"  name="usr" placeholder="" required="required"></td>
																<td class="redstar">*</td>
															</tr>
															<tr>
																<td>Email</td>
																<td><input type="email" class="form-control" name=email placeholder="" required="required"></td>
																<td class="redstar">*</td>
															</tr>
														</tbody>
													</table>
									...
									<div class="col-xs-8 col-sm-3 col-md-9 col-xs-offset-3 col-sm-offset-5 col-md-offset-4 mgt10 alert">
										<%
								...
								<div
									class="col-xs-8 col-sm-3 col-md-3 col-xs-offset-3 col-sm-offset-5 col-md-offset-4 mgt10">
								...
								<ul>
									<li>
										...
										<ul class="sub-menu-side">
											...
											<li><a href=""><span class="loading"></span>Hồ Chí
													Minh</a></li>
										</ul>
									</li>
									<li>
									...
									<li>
										<p>Miền Bắc - 18h15</p>
										<ul class="sub-menu-side">
											<li><a href=""><span class="waiting"></span>Quảng
													Ninh</a></li>
										</ul>
									</li>
									<li>
