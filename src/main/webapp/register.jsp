						...
						<form method="post" action="register">
							<div class="kqsx-first">
								<div class="box-kqxs" id="box-ckqxs">
									...
									<div class="box-kqxs-content row-eq-height">
										<div class="col-md-12 col-xs-12 col-xs-12-pad mm-result-left paddingtb10">
												...
												<div class="col-md-7">
													<table class="table">
														<tbody>
															<tr>
																<td>Tên đăng nhập</td>
																<td><input type="text" class="form-control" id="" name="usr" placeholder="" required="required"></td>
																<td class="redstar">*</td>
															</tr>
															<tr>
																<td>Mật khẩu</td>
																<td><input type="password" class="form-control" id="" name="pwd" placeholder="" required="required"></td>
																<td class="redstar">*</td>
															</tr>
															<tr>
																<td>Nhập lại mật khẩu</td>
																<td><input type="password" class="form-control" id="" name="repass" placeholder="" required="required"></td>
																<td class="redstar">*</td>
															</tr>
															<tr>
																<td>Họ và tên</td>
																<td><input type="text" class="form-control" id="" name="name" placeholder="" required="required"></td>
																<td class="redstar">*</td>
															</tr>
															<tr>
																<td>Email</td>
																<td><input type="email" class="form-control" id="email" name="mail" placeholder="" required="required"></td>
																<td class="redstar"></td>
															</tr>
															<tr>
																<td>Địa chỉ</td>
																<td><input type="text" class="form-control" id="" name="address" placeholder="" ></td>
																<td class="redstar"></td>
															</tr>
															<tr>
																<td>Điện thoại</td>
											...
											<div style="text-align: center; color: red;" class="alert">
												${warning}</div>
										</div>
								...
								<div class="col-xs-8 col-sm-3 col-md-3 col-xs-offset-3 col-sm-offset-5 col-md-offset-4 mgt10">
									<button type="submit" class="btn btn-danger pull-left">Đăng ký</button>
						...
						<div class="direct">
							...
							<div class="direct-content">
								...
								<div class="embed-link">
									<a href="">
									<img src="images/banner.jpg" height="40" width="40" alt="">Chèn KQXS vào Website</a>
								</div>
							</div>
						</div>
						<!-- End direct -->
